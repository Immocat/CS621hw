...
public:
	...
	void best_k_sources(SurfacePoint& point, unsigned int *best_src_indices, double * best_src_distances);// find k nearest source, 
	// return from nearest to farthest
...
inline void GeodesicAlgorithmExact::best_k_sources(SurfacePoint& point, unsigned int *best_src_indices, double * best_src_distances){
	//
}
