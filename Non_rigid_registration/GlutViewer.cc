...
void GlutViewer::clear_draw_modes() {
  for (unsigned int i = 0; i < n_draw_modes_; ++i) glutRemoveMenuItem(1);
...
GlutViewer* GlutViewer::current_window() { return windows__[glutGetWindow()]; }
...
void GlutViewer::processmenu(int i) { set_draw_mode(i); }
